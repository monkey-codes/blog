...
<Gist id="d43816c846785bb691f9062f963037fd" />
...
[Merge sort](/blog/analyzing-the-merge-sort-algorithm) is an example of a _Divide and Conquer_ algorithm. Recursively split the input array until you have arrays with $\\le 2$ elements. Then merge 2 adjacent arrays by comparing the first elements, since each array is already sorted. Rinse and Repeat.
...
<Gist id="ff350d47537fcd05715e3421e2840918" />

In part 2 of this series I will look at [hash functions & maps](/blog/tech-interview-cheatsheet-maps-hashing).
