...
In Part 1 of this series I looked at [common search and sorting algorithms used on Lists](/blog/tech-interview-cheatsheet-lists-search-sort). This post will look at _Hash functions_ and how they are applied to _Sets_ and _Maps_ to offer constant time lookup performance.
...
In part 3 I will look at [trees](/blog/tech-interview-cheatsheet-trees).
